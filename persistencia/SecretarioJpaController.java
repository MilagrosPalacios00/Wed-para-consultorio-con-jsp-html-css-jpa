...
public class SecretarioJpaController implements Serializable {
    ...
    public void edit(Secretario secretario) throws Exception {
        ...
        try {
            ...
            if (findSecretario(secretario.getId()) == null) {
                throw new Exception("The secretario with id " + secretario.getId() + " no longer exists.");
            }
            throw ex;
        } finally {
            if (em != null) {
    ...
    public void destroy(int id) throws Exception {
        ...
        try {
            ...
            try {
                ...
                throw new Exception("The secretario with id " + id + " no longer exists.", ex);
            }
